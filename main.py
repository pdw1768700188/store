print("xxxxxxxx衣服销售数据统计与分析xxxxxxxx")
print("日期   服装名称 价格/件  库存量  销售量每日    每日销售额")
...
print("销售总额=",(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78))
print("平均每日销售总额=",(198400/30))
print("平均每日销售量",(1844/30))
print("T恤月销售占比=",(431/1844))
print("衬衫月销售占比=",(69/1844))
print("风衣月销售占比=",(324/1844))
print("牛仔裤月销售占比=",(428/1844))
print("皮草月销售占比=",(306/1844))
print ("羽绒服月销售占比=",(251/1844))
